...
#define BT_WOBT_BY_SDIO_EINT "SUPPORT_WOBT_BY_SDIO_EINT"
...
struct bt_cfg_struct {
	...
	bool	support_wobt_by_sdio;		/* support SDIO wake up or not */
	...
	bool	support_send_vsc_cmd;		/*support send vsc cmd to FW*/
...
struct btmtk_sdio_card {
	...
	struct		wakeup_source *wobt_ws;
	struct		timer_list wake_lock_timer;
	unsigned int					wake_lock_attempt_count;
